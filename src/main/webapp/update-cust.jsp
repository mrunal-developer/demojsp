            ...
            <div class="col">
                <form action="update-customer" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="inputFirstName" name="customer-id" value="<%=customer.getCustomerId()%>" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary">Confirm Update Student</button>
                  </form>
            </div>
            <div class="col"></div>
        </div>
